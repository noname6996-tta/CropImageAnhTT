package com.tta.cropimageanhtt.crop;
...
import com.tta.cropimageanhtt.crop.config.ConfigChangeListener;
import com.tta.cropimageanhtt.crop.config.CropIwaImageViewConfig;
import com.tta.cropimageanhtt.crop.config.CropIwaOverlayConfig;
import com.tta.cropimageanhtt.crop.config.CropIwaSaveConfig;
import com.tta.cropimageanhtt.crop.image.CropArea;
import com.tta.cropimageanhtt.crop.image.CropIwaBitmapManager;
import com.tta.cropimageanhtt.crop.image.CropIwaResultReceiver;
import com.tta.cropimageanhtt.crop.shape.CropIwaShapeMask;
import com.tta.cropimageanhtt.crop.util.CropIwaLog;
import com.tta.cropimageanhtt.crop.util.LoadBitmapCommand;
...
public class CropIwaView extends FrameLayout {
    ...
    private ReadyCropImage readyCropImage;

    private CropIwaResultReceiver cropIwaResultReceiver;

    public void setReadyCropImage(ReadyCropImage readyCropImage) {
        this.readyCropImage = readyCropImage;
    }
    ...
    public void setImage(Bitmap bitmap) {
        ...
        if (readyCropImage != null) readyCropImage.onReady();
    }
    ...
    public interface ReadyCropImage{
        void onReady();
    }
