...
import static com.tta.cropimageanhtt.crop.util.CropIwaUtils.boundValue;
import static com.tta.cropimageanhtt.crop.util.CropIwaUtils.enlargeRectBy;
import static com.tta.cropimageanhtt.crop.util.CropIwaUtils.moveRectBounded;
...
import com.tta.cropimageanhtt.crop.shape.CropIwaShape;
import com.tta.cropimageanhtt.crop.util.CropIwaUtils;
import com.tta.cropimageanhtt.utils.Utils;
...
class CropIwaDynamicOverlayView extends CropIwaOverlayView {
    ...
    private static final float CLICK_AREA_CORNER_POINT = Utils.dpToPx(24);
